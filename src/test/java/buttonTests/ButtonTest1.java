...
public class ButtonTest1 {
    ...
    @Test
    public void step_1(){
        buttonsPage.openButtonsPage(); //открыть страницу с кнопками
        buttonsPage.doubleClick(DOUBLE_CLICK_BTN);
        Assert.assertTrue(buttonsPage.isMessageDisplay(MESSAGE_DOUBLE_CLICK));//проверяем, что 2-й клик сработал
    }
    @Test
    public void step_2(){
